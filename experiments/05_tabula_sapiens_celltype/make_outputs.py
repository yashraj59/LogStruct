"""Build Tabula Sapiens pilot outputs from logged results."""
...
RESULTS = ROOT / "results" / "tabula_sapiens_immune" / "results.json"
...
def main() -> None:
    ...
    df[display_cols].to_csv(TABLE_DIR / "table_tabula_500g.csv", index=False)
    (TABLE_DIR / "table_tabula_500g.md").write_text(_to_markdown(df[display_cols]))
